...
public class ChangeKey extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Change Encryption Key");

        jLabel4.setForeground(new java.awt.Color(255, 255, 51));
        jLabel4.setText("Current Key:");

        jLabel5.setForeground(new java.awt.Color(255, 255, 51));
        jLabel5.setText("New Key (at least 9 letters):");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        if(!Main.it.checkKey(key)){
                KeyIncorrect ki=new KeyIncorrect();
                ki.setVisible(true);
        }
        else{
            try {
                Main.it.setKey(jTextField2.getText());
            } catch (BadPaddingException ex) {
                Logger.getLogger(ChangeKey.class.getName()).log(Level.SEVERE, null, ex);
