...
public class companyRevenue extends javax.swing.JFrame {

    
    public companyRevenue() {
        initComponents();Main.it.play("sound//ka-ching.wav");
        jLabel2.setText("RM"+Main.it.getCompanyRevenue());
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Company Revenue");
    ...
    public static void rev() {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new companyRevenue().setVisible(true);
            }
        });
    }
