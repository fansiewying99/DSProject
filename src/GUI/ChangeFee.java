...
public class ChangeFee extends javax.swing.JFrame {
    ...
    public ChangeFee() {
        initComponents();
        jLabel4.setText("RM"+Main.it.getFee());Main.it.play("sound//page flip.wav");
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Change Registration Fee");

        jLabel2.setForeground(new java.awt.Color(255, 255, 0));
        jLabel2.setText("Current Registration Fee: ");

        jLabel3.setForeground(new java.awt.Color(255, 255, 0));
        jLabel3.setText("Enter new Registration Fee: ");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        Main.it.setRegistrationFee(Double.parseDouble(jTextField1.getText()));
