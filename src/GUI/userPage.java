...
public class userPage extends javax.swing.JFrame {
    ...
    public userPage() {
        Main.it.play("sound//page flip.wav");initComponents();
        jLabel2.setText(Main.it.getUserID());
        jLabel4.setText("RM"+Main.it.getUserRevenue());
        ArrayList<String> act=Main.it.viewActivity();
        jTextArea1.setLineWrap(true);
        jTextArea1.setWrapStyleWord(true);
        if(act.size()!=0){
            for(int i=0; i<act.size(); i++){
                jTextArea1.append(act.get(i));
                jTextArea1.append("\n");
            }
        }
    }
